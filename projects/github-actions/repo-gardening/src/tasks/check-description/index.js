...
2. Choose a review path based on your changes:
    A. Team Review: add the [ [Status] Needs Team Review](https://github.com/jeherve/jetpack/labels/%5BStatus%5D%20Needs%20Team%20Review) label
      - For most changes, including minor cross-team impacts.
      - Example: Updating a team-specific component or a small change to a shared library.
    B. Crew Review: add the [ [Status] Needs Review](https://github.com/jeherve/jetpack/labels/%5BStatus%5D%20Needs%20Review) label
